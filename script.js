...
const TRANSLATIONS = {
    ...
    'hero.h1': { en: 'Laser hair removal and skincare in Grande Digue, NB', fr: 'Épilation au laser et soins de la peau à Grande-Digue, NB' },
    'hero.subhead': { en: 'Step into a calm coastal oasis for comfortable, results-driven treatments designed around you—from first visit to final glow.', fr: 'Entrez dans une oasis côtière apaisante pour des soins confortables et axés sur les résultats, imaginés pour vous — de la première visite à l\'éclat final.' },
    ...
    'reviews.q1': { en: '"Great experience, very soothing and professional."', fr: '"Superbe expérience, très apaisante et professionnelle."' },
